...
async function main() {
  console.log("🚀 Deploying BRICS Token to Ethereum Mainnet (Safe Mode)...");
  ...
  // SimpleBRICSToken is smaller than the original, so we can use less gas
  const gasLimit = BigInt(800000); // Conservative estimate for simple contract
